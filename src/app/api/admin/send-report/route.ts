  ...
  try {
    ...
    const emailResult = await resend.emails.send({
      ...
      html: \
        ...
        <ul>
          <li><b>Records verified so far:</b> \</li>
          <li><b>Current Jobs count:</b> \</li>
          <li><b>Current Tenders count:</b> \</li>
          <li><b>Current Compliance count:</b> \</li>
        </ul>
        <p>Total remaining to verify: \</p>
