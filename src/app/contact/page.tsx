    ...
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <div className="space-y-10">
        ...
        <section className="bg-white/5 border border-white/10 rounded-xl p-6 space-y-4">
          ...
          <div className="flex flex-wrap gap-3">
            {[
              { label: 'X / Twitter', href: 'https://twitter.com/akilibrain' },
              { label: 'LinkedIn', href: 'https://linkedin.com/company/akilibrain' },
              { label: 'GitHub', href: 'https://github.com/danieljohnfas/akilihub' },
            ].map(({ label, href }) => (
              <a
                key={label}
                href={href}
